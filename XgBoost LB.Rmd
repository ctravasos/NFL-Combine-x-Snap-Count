...
LB_data$heights_in_inches <- sapply(LB_data$Ht, convert_to_inches)



set.seed(12345)
train_index <- sample(1:nrow(LB_data), 0.8 * nrow(LB_data))
train_data <- LB_data[train_index, ]
test_data <- LB_data[-train_index, ]
...
Best iteration is 274, set to 300 with early stopping 20
...
Min child weight 1, max depth 5
```{r}
res_db
```
