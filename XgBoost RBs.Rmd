...
RB_data$heights_in_inches <- sapply(RB_data$Ht, convert_to_inches)



set.seed(12345)
train_index <- sample(1:nrow(RB_data), 0.8 * nrow(RB_data))
...
Best iteration is 282, set to 300 with early stopping 20
