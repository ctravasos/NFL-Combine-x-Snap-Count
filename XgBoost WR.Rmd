...
WR_data$heights_in_inches <- sapply(WR_data$Ht, convert_to_inches)



set.seed(12345)
train_index <- sample(1:nrow(WR_data), 0.8 * nrow(WR_data))
train_data <- WR_data[train_index, ]
test_data <- WR_data[-train_index, ]
...
Best iteration is 172, set to 200 with early stopping 20
...
Min child weight 1, max depth 3
```{r}
res_db
```
