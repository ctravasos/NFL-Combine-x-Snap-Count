...
dataset_unique$heights_in_inches <- sapply(dataset_unique$Ht, convert_to_inches)



set.seed(12345)
train_index <- sample(1:nrow(dataset_unique), 0.8 * nrow(dataset_unique))
train_data <- dataset_unique[train_index, ]
test_data <- dataset_unique[-train_index, ]
...
```
Best iteration is 59, set to 90 with early stopping 20
...
g1 
```
Min child weight 3, max depth 10
```{r}
res_db
```
tune gamma
